...
This looks at the entire user experience from one end to another end. It focuses on the User Interface (UI) and mimic how a user might interact with an app, simulating real events like button clicks, scrolls, form submits and the likes.
